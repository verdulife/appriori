...
export function nonRecursiveQsort(array) {
  var stack = [];
...
export function nonBlockingQsort(array, successCallback) {
  var stack = [];
...
export function nonBlockingQsort2(array, successCallback) {
  var asyncCompare = function (x, y, callback) {
    result = x > y ? 1 : x < y ? -1 : 0;
    //console.log(x,y, result);
    callback(result);
...
export function nonBlockingQsort3(array, successCallback) {
